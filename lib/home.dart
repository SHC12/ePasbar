                  ...
                  FadeAnimation(
                    ...
                    Container(
                        ...
                        child: DataTable(columns: <DataColumn>[
                          ...
                          DataRow(
                            cells: <DataCell>[
                              DataCell(Text(tanggal1.toString())),
                              DataCell(Text(judul1.toString())),
                          ...
                          DataRow(
                            cells: <DataCell>[
                              DataCell(Text(tanggal2.toString())),
                              DataCell(Text(judul2.toString())),
                              DataCell(GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                          ...
                          DataRow(
                            cells: <DataCell>[
                              DataCell(Text(tanggal3.toString())),
                              DataCell(Text(judul3.toString())),
                               DataCell(GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                        context,
